...
public class GuestLogin extends JFrame {
    ...
    // 파일 기반 매핑
    // ex) "서울특별시" -> "김도윤"
    private final Map<String, String> regionToDriver = new HashMap<String, String>();
    // ex) "강태빈" -> "한진"
    private final Map<String, String> senderToCompany = new HashMap<String, String>();
    ...
    private void updateDateLabel() {
        String dateStr = DeliverySystem.getCurrentDateString();
    ...
    private void onSearchByInvoice() {
        ...
        List<DeliveryOrder> filtered = new ArrayList<DeliveryOrder>();
    ...
    private void onUpdateDate() {
        ...
        List<DeliveryOrder> listToShow = new ArrayList<DeliveryOrder>();
        ...
        String msg = "현재 날짜: " + DeliverySystem.getCurrentDateString()
                + "\n배송 상태가 업데이트되었습니다.";
